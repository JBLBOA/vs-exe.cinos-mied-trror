...
class DiscordClient
{
	...
	private static var _defaultID:String = "1173355958437679164";
	...
	public static function changePresence(details:String, state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		_options.largeImageText = "CINOS MIEDO VERSION: " + states.MainMenuState.psychEngineVersion;
